...
fn zh(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "menu.install_twin_local" => "安装数字分身套件（本地调试）…",
        "menu.install_twin_release" => "安装/更新数字分身套件（生产·GitHub）…",
...
fn en(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "menu.suite" => "Digital Twin Suite",
        "menu.logs" => "Logs & Diagnostics",
        ...
        "menu.install_twin_local" => "Install Digital Twin Suite (Local Debug)…",
        "menu.install_twin_release" => "Install/Update Digital Twin Suite (Production·GitHub)…",
...
mod tests {
    ...
    fn zh_table_has_all_menu_keys() {
        for k in [
            ...
            "menu.suite", "menu.logs",
            "menu.about",
            "menu.qrcode", "menu.export_diagnostics", "menu.install_twin_local", "menu.install_twin_release", "menu.reset_home", "menu.quit",
